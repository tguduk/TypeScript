namespace ts.server {
    ...
    export class ProjectService {
        ...
        getProjectForFileWithoutOpening(fileName: NormalizedPath): { readonly scriptInfo: ScriptInfo, readonly projects: ReadonlyArray<Project> } | undefined {
            ...
            const project = this.findConfiguredProjectByProjectName(configFileName) || this.createAndLoadConfiguredProject(configFileName);
            updateProjectIfDirty(project);
            return project.containsScriptInfo(scriptInfo) ? { scriptInfo, projects: [project] } : undefined;
        }
